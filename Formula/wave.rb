class Wave < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/make-wave/wave/releases/download/v0.0.4/wave-macos-arm64"
  ...
  on_linux do
    url "https://github.com/make-wave/wave/releases/download/v0.0.4/wave-linux-x86_64"
